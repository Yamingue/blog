 ...
 */
final class Version20210425222336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, type_id, content, titre, is_aprouve FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER DEFAULT NULL, content CLOB DEFAULT NULL COLLATE BINARY, titre VARCHAR(255) NOT NULL COLLATE BINARY, is_aprouve BOOLEAN DEFAULT NULL, make_at DATETIME NOT NULL, CONSTRAINT FK_23A0E66C54C8C93 FOREIGN KEY (type_id) REFERENCES type_revu (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO article (id, type_id, content, titre, is_aprouve) SELECT id, type_id, content, titre, is_aprouve FROM __temp__article');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, type_id, content, titre, is_aprouve FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER DEFAULT NULL, content CLOB DEFAULT NULL, titre VARCHAR(255) NOT NULL, is_aprouve BOOLEAN DEFAULT NULL)');
        $this->addSql('INSERT INTO article (id, type_id, content, titre, is_aprouve) SELECT id, type_id, content, titre, is_aprouve FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E66C54C8C93 ON article (type_id)');
        $this->addSql('DROP INDEX IDX_6A2CA10C7294869C');
